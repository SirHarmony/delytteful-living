export default function About() {
  ...
  return (
    ...
    >
      {/* Background accent */}
      <div className="absolute top-0 right-0 w-1/3 h-full bg-rose-light opacity-30 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          >
            ...
            <span className="italic text-rose-deep">delight</span> in every
            dimension of life.
          </h2>
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Stats row */}
          <div className="grid grid-cols-3 gap-px bg-cream-dark">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-cream p-8 flex flex-col items-center text-center gap-2"
              >
          ...
          <div className="border border-cream-dark p-6 flex items-start gap-4">
            <div className="w-1 self-stretch bg-rose flex-shrink-0" />
            <div>
