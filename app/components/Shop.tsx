    ...
    <section id="shop" className="bg-cream py-28 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="font-body font-light text-warm-grey mt-5 max-w-md mx-auto text-[15px] leading-relaxed">
        ...
        {/* Products grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-px bg-cream-dark">
        ...
        <div className="mt-16 grid sm:grid-cols-2 gap-px bg-cream-dark">
          <a
            ...
            className="bg-charcoal text-cream p-10 flex items-center justify-between group hover:bg-rose-deep transition-colors duration-500"
          >
            <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-cream-dark text-charcoal p-10 flex items-center justify-between group hover:bg-rose-light transition-colors duration-500"
          >
            <div>
