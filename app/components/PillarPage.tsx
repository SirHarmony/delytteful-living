                ...
                <ScrollReveal key={musicEmbed.spotifyOpenUrl}>
                  <section className="mb-12">
                    <a
                      ...
                      className="inline-flex items-center gap-2 font-body text-[11px] tracking-[0.2em] uppercase px-6 py-3.5 rounded-full bg-[#1DB954] text-white hover:bg-[#1ed760] transition-colors mb-4 active:scale-[0.98]"
                    >
                      <svg
                        viewBox="0 0 24 24"
                    ...
                    <p className="font-body text-[10px] text-warm-grey mb-3 max-w-2xl">
                      Or preview the playlist on this page (Spotify account may
                      be required for full playback).
                    </p>
          ...
          <ScrollReveal>
            <section className="border-t border-parchment-dark pt-14">
              ...
              <p className="font-body text-sm text-warm-grey mb-8 max-w-xl">
                More in this pillar — add cross-pillar bundles in data when
                ready.
              </p>
              ...
              <p className="mt-10 font-body text-xs text-warm-grey">
                All prices in{" "}
                <span className="text-charcoal font-medium">USD</span>. See{" "}
